...
public class BloodWaveReg
{
    ...
    public void LoadWave(int waveId)
    {
        ...
        int beforeSkelBoss = BloodEnemyBoss.BloodSkeletonRegistry.All.Count;
        ...
        if (waveId == 2)
        {
             BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(4);
            //  BloodEnemyBoss.BloodSkeletonRegistry.SpawnSkeletons(1);
            //  BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(1);
            // BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
//BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(1);
        ...
        if (waveId == 3)
        {
              BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(5);
            //  BloodEnemyBoss.BloodSkeletonRegistry.SpawnSkeletons(1);
            //  BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(1);
            // BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(1);
        ...
        var newSkelBoss=BloodEnemyBoss.BloodSkeletonRegistry.All.Skip(beforeSkelBoss).ToList();
        ...
        waveEntities.AddRange(newSkelBoss);
        ...
        foreach (var entity in waveEntities)
        {
            switch (entity)
            {
                ...
                case BloodBoss.ScavBoss f:
                    ...
                    break;
                case BloodEnemyBoss.Skeleton r:
                    r.SetAggressionTarget(ActiveCharacter);
                    break;
            }
        }
    ...
    public bool IsWaveCooked()
    {
        ...
        foreach (var entity in Waves[currentWave])
        {
            switch (entity)
            {
                ...
                case BloodEnemyBoss.Skeleton r when r.SkeletonIsAlive:
                    return false;
            }
        }
