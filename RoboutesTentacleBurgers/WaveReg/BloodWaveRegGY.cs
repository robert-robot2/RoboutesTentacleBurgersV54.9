...

{
    ...
    private int lastWaveId = 4; // change per map (e.g. 5 for dungeons)
    ...
    public void LoadWave(int waveId)
    {
        ...
        if (waveId == 1)
        {
          //  BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(15);
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(15);
            //   BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
               BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(10);
        ...
        if (waveId == 2)
        {
          //  BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(25);
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(20);
            // BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(15);
            //  BloodGoatMan.BloodGoatmanRegistry.SpawnGoatmen(1);
            // BloodBoss.BloodScavBossRegistry.SpawnScavBoss(1);
        }
        ...
        if (waveId == 3)
        {
          //  BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(30);
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(25);
             BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(3);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(20);
            //  BloodGoatMan.BloodGoatmanRegistry.SpawnGoatmen(1);
            // BloodBoss.BloodScavBossRegistry.SpawnScavBoss(1);
            //  BloodEnemyBoss.BloodSkeletonRegistry.SpawnSkeletons(1);
        }
        if (waveId == 4)
        {
          //  BloodEnemy.BloodSkeletonRegistry.SpawnSkeletons(50);
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(35);
             BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(5);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(25);
            //  BloodGoatMan.BloodGoatmanRegistry.SpawnGoatmen(1);
            // BloodBoss.BloodScavBossRegistry.SpawnScavBoss(1);
            BloodEnemyBoss.BloodSkeletonRegistry.SpawnSkeletons(1);
        }
