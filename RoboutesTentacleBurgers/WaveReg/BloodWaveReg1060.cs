...
public class BloodWaveReg1060
{
    ...
    private int lastWaveId = 5; // change per map (e.g. 5 for dungeons)
    ...
    public void LoadWave(int waveId)
    {
        ...
        if (waveId == 2)
        {
            ...
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(3);
            // BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(4);
            //  BloodGoatMan.BloodGoatmanRegistry.SpawnGoatmen(1);
            // BloodBoss.BloodScavBossRegistry.SpawnScavBoss(1);
        }
        ...
        if (waveId == 3)
        {
            ...
            BloodZombiePyscho.BloodZombiePyschoRegistry.SpawnZombiePyschos(4);
            BloodSkelWar.BloodSkeletonWarRegistry.SpawnSkeletonWars(1);
            BloodSkelPyscho.BloodSkelPyschoRegistry.SpawnSkelPyschos(7);
            //  BloodGoatMan.BloodGoatmanRegistry.SpawnGoatmen(1);
            // BloodBoss.BloodScavBossRegistry.SpawnScavBoss(1);
        }
        if (waveId == 4)
