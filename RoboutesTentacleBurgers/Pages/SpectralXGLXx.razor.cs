using static RoboutesTentacleBurgers.SpectralXComponent.SpectralXEngine;

namespace RoboutesTentacleBurgers.Pages
{
    public partial class SpectralXGLXx : IDisposable
    {
 ...
 new { url = "iMeshes/Roboute001.fbx",          name = "Roboute" },
        ...
        new { url = "iMeshes/Shack001.fbx",      name = "Shack001" },
                ...
                await JS.InvokeVoidAsync("SpectralGLLoader.reset", false, false);
        ...
        {
            if (int.TryParse(e.Value?.ToString(), out int mode))
                Engine.SetCameraMode((SpectralXEngine.CameraMode)mode);
        }
        public void Dispose()
        {
