...
public class BloodStaticO1020
    {


    public class BloodStaticList1020
    {
        ...
        public static Dictionary<string, int> ForestDictionary() => new()
{
        ...
        public static Dictionary<string, (int shiftX, int shiftY, int w, int h)> CollisionMap = new()
    {
        ...
        public BloodStaticList1020(string type, int x, int y)
        {
            Type = type;
            X = x;
            Y = y;
    ...
    public static class BloodStaticRegistry1020
    {
        public static readonly List<BloodStaticList1020> All = new();
            ...
            foreach (var kvp in typeCounts)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    do
                    {
                        ...
                        newObj = new BloodStaticList1020(type, x, y);
                        attempts++;
        ...
        private static bool IsOverlapping(BloodStaticList1020 candidate, List<IiEnemy> Enemys, List<IDynamicO> dynO,
            List<IBreakables> breakables,
