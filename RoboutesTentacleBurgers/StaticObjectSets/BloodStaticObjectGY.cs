...
public class BloodStaticObjectGY
{



    public class BloodStaticListGY
    {
        ...
        public static Dictionary<string, int> ForestDictionary() => new()
{
        ...
        public static Dictionary<string, (int shiftX, int shiftY, int w, int h)> CollisionMap = new()
    {
        ...
        public BloodStaticListGY(string type, int x, int y)
        {
            Type = type;
            X = x;
            Y = y;
    ...
    public static class BloodStaticRegistryGY
    {
        public static readonly List<BloodStaticListGY> All = new();
            ...
            foreach (var kvp in typeCounts)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    do
                    {
                        ...
                        newObj = new BloodStaticListGY(type, x, y);
                        attempts++;
        ...
        private static bool IsOverlapping(BloodStaticListGY candidate, List<IiEnemy> Enemys, List<IDynamicO> dynO,
            List<IBreakables> breakables,
