...
public class BloodStaticO1040
    {



    public class BloodStaticList1040
    {
        ...
        public static Dictionary<string, int> ForestDictionary() => new()
{
        ...
        public static Dictionary<string, (int shiftX, int shiftY, int w, int h)> CollisionMap = new()
    {
        ...
        public BloodStaticList1040(string type, int x, int y)
        {
            Type = type;
            X = x;
            Y = y;
    ...
    public static class BloodStaticRegistry1040
    {
        public static readonly List<BloodStaticList1040> All = new();
            ...
            foreach (var kvp in typeCounts)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    do
                    {
                        ...
                        newObj = new BloodStaticList1040(type, x, y);
                        attempts++;
        ...
        private static bool IsOverlapping(BloodStaticList1040 candidate, List<IiEnemy> Enemys, List<IDynamicO> dynO,
            List<IBreakables> breakables,
