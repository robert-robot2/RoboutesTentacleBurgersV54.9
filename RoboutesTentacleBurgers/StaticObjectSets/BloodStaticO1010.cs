...
public class BloodStaticO1010
    {


    public class BloodStaticList1010
    {
        ...
        public static Dictionary<string, int> ForestDictionary() => new()
{
        ...
        public static Dictionary<string, (int shiftX, int shiftY, int w, int h)> CollisionMap = new()
    {
        ...
        public BloodStaticList1010(string type, int x, int y)
        {
            Type = type;
            X = x;
            Y = y;
    ...
    public static class BloodStaticRegistry1010
    {
        public static readonly List<BloodStaticList1010> All = new();
            ...
            foreach (var kvp in typeCounts)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    do
                    {
                        ...
                        newObj = new BloodStaticList1010(type, x, y);
                        attempts++;
        ...
        private static bool IsOverlapping(BloodStaticList1010 candidate, List<IiEnemy> Enemys, List<IDynamicO> dynO,
            List<IBreakables> breakables,
