...
public class BloodCat 
{
    ...
    //   public void StopMovement(string key) => StopMovementWarrior(key);
       ...
       public int EnemyY => SkeletonY;
        ...
        public string? HitEffectPath => ShowSkeletonHitEffect ? "/iAssets/WarriorGothit01.png" : null;
     ...
     //   public int EnemyHungerDurationSeconds { get => SkeletonHungerDurationSeconds; set => SkeletonHungerDurationSeconds = value; }
        ...
        public int SkeletonWidth { get; set; } = 40;
        public int SkeletonHeight { get; set; } = 40;
        ...
        public int SkeletonMaxHP { get; set; } = 5000;
        ...
        public int SkeletonAlacrityAmount = 5;
        ...
        public const int SkeletonFrameWidth = 40;
        public const int SkeletonFrameHeight = 40;
...
{
    { SkeletonAnimationState.Idle, 5 },
    { SkeletonAnimationState.WalkLeft, 8},
    { SkeletonAnimationState.WalkRight, 8 },
    { SkeletonAnimationState.Attack, 7 },
             { SkeletonAnimationState.Flex, 1},
 ...
 { SkeletonAnimationState.WalkDown, 8}
        ...
        {
            SkeletonAnimationState.Idle => "/iAssets/BCatIdle001.png",
            SkeletonAnimationState.WalkLeft => "/iAssets/BCatwalkL001.png",
            SkeletonAnimationState.WalkRight => "/iAssets/BCatwalkR001.png",
            SkeletonAnimationState.Attack => "/iAssets/BCatAttack001.png",
            SkeletonAnimationState.Flex => "/iAssets/BCatwalkPD002.png",//repalced with solo png cell.
            SkeletonAnimationState.WalkUp => "/iAssets/BCatwalkU001.png",
            SkeletonAnimationState.WalkDown => "/iAssets/BCatwalkD001.png",

            _ => "/iAssets/BCatIdle001.png"
        };
