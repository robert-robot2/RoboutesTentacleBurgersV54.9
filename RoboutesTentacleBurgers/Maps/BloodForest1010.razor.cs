...
namespace RoboutesTentacleBurgers.Maps
{
    public partial class BloodForest1010 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            WaveReg1010.LoadWave(1);
            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveReg1010.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticO1010.BloodStaticList1010.ForestDictionary();
            BloodStaticO1010.BloodStaticRegistry1010.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
