...
{
    public partial class BloodCaveSys1 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveRegC.TryAdvanceWave());
            ...
            LightHandle = new BloodLightHandle(LightingType.Cave);
            Game.LightHandle = LightHandle;  // Important!
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticObjectC.BloodStaticListC.CaveDictionary();
            BloodStaticObjectC.BloodStaticRegistryC.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
