...
namespace RoboutesTentacleBurgers.Maps
{
    public partial class BloodForest1030 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            Spawn();
            // Load first wave
            WaveReg1030.LoadWave(1);

            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveReg1030.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticO1030.BloodStaticList1030.ForestDictionary();
            BloodStaticO1030.BloodStaticRegistry1030.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
