...
namespace RoboutesTentacleBurgers.Maps
{
    public partial class DarkForest1060 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            // Load first wave
            WaveReg1060.LoadWave(1);

            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveReg1060.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticO1060.BloodStaticList1060.ForestDictionary();
            BloodStaticO1060.BloodStaticRegistry1060.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
