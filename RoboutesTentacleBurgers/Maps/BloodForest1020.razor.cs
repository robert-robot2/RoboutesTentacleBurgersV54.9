...
namespace RoboutesTentacleBurgers.Maps
{
    public partial class BloodForest1020 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            Spawn();
            // Load first wave
            WaveReg1020.LoadWave(1);
            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveReg1020.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticO1020.BloodStaticList1020.ForestDictionary();
            BloodStaticO1020.BloodStaticRegistry1020.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
