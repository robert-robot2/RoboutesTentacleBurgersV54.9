...
using static BloodStaticObjectGY;
using static BloodZombiePyscho;

namespace RoboutesTentacleBurgers.Maps
{
    public partial class BloodGraveYard : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            Spawn();
            // Load first wave
            WaveRegGY.LoadWave(1);


            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveRegGY.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticObjectGY.BloodStaticListGY.ForestDictionary();
            BloodStaticObjectGY.BloodStaticRegistryGY.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
