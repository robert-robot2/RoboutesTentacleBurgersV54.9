...
namespace RoboutesTentacleBurgers.Maps
{
    public partial class DarkForest1050 : ComponentBase, IDisposable
    {
        ...
        protected override void OnInitialized()
        {
            ...
            // Clear All Spawns onmap transistor
            Game.ClearAll();
            Spawn();
            // Load first wave
            WaveReg1050.LoadWave(1);

            // Wave timer
            waveCheckTimer = new System.Timers.Timer(16);
            waveCheckTimer.Elapsed += (_, __) => InvokeAsync(() => WaveReg1050.TryAdvanceWave());
        ...
        public void HandleObjSpawn2()
        {
            ...
            var dict = BloodStaticO1050.BloodStaticList1050.ForestDictionary();
            BloodStaticO1050.BloodStaticRegistry1050.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
