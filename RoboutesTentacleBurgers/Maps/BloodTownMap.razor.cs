...
{
    public partial class BloodTownMap : ComponentBase, IDisposable
    {
        ...
        public void Spawn()
        {
            BloodStaticObjectT.HouseRegistry.SpawnHousess(3);
            BloodStaticObjectT.Fountain001Registry.SpawnFountains(2);
            BloodStaticObjectT.Tavern001Registry.SpawnTaverns(1);
            BloodStaticObjectT.ShrineRegistry.SpawnShrines(3);
            // Spawn Static Set
            HandleObjSpawn2();
        ...
        public void HandleObjSpawn2()
        {
            ...
            allStatics.AddRange(BloodStaticObjectT.HouseRegistry.All);
            allStatics.AddRange(BloodStaticObjectT.Fountain001Registry.All);
            allStatics.AddRange(BloodStaticObjectT.Tavern001Registry.All);
            allStatics.AddRange(BloodStaticObjectT.ShrineRegistry.All);



            var dict = BloodStaticObjectT.BloodStaticListT.TownDictionary();
            BloodStaticObjectT.BloodStaticRegistryT.SpawnByType(
                dict,
                2048, 2048,
                25, 150,
                25, 200,
