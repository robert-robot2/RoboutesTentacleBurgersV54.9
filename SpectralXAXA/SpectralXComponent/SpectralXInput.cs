...

{
    ...
    {
        public readonly SpectralXAX SpectralX;
        public readonly IJSRuntime JS;
        public readonly SpectralXCamera Camera;

        public readonly SpectralXViewport Viewport;  // Viewport reference
        ...
        public bool ShowDebugOverlay { get; private set; } = false;
        ...
        // needs to call viewport-->> to uncomment SpectralX.razor.cs

        public SpectralXInput(SpectralXAX spectralX, SpectralXViewport viewport,SpectralXSVGViewport xSVGViewport, SpectralXCamera camera, IJSRuntime js)
        {
            SpectralX = spectralX;  // Store SpectralX (the whole page)
            Viewport = viewport;
            SVGViewport = xSVGViewport; // Store Viewport
            Camera = camera;        // Store Camera
            JS = js;            
